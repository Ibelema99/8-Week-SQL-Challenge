...
/*2. In runner_orders, replace 'null' by null, remove km from distance and minutes from duration 
- change duration to int distance to float*/
...
-- 3. change datatypes for temp_runner_orders
